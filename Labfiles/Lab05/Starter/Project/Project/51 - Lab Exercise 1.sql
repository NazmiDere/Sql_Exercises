...
---------------------------------------------------------------------
SELECT custid, companyname, contactname, address, city, country, phone FROM Sales.Customers WHERE country = 'Brazil'
...
SELECT custid, companyname, contactname, address, city, country, phone FROM Sales.Customers WHERE country IN ('Brazil', 'UK', 'USA')
...
SELECT custid, companyname, contactname, address, city, country, phone FROM Sales.Customers WHERE contactname LIKE 'A%'
...
FROM Sales.Customers AS c
LEFT OUTER JOIN Sales.Orders AS o ON c.custid = o.custid WHERE c.city = N'Paris';
...
SELECT c.custid, c.companyname FROM Sales.Customers AS c lEFT OUTER JOIN Sales.Orders AS o ON c.custid = o.custid  WHERE o.custid IS NULL