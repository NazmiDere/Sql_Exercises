...
---------------------------------------------------------------------
SELECT contactname, city, CONCAT(contactname, '(city:', city, ')')
...
---------------------------------------------------------------------
SELECT contactname, city, region, CONCAT(contactname, '(city:', city, 'region:', COALESCE(region, ' '), ')')
FROM Sales.Customers   
...
SELECT contactname, contacttitle FROM Sales.Customers WHERE contactname LIKE N'[A-G]%'