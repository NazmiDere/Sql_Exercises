...
SELECT * INTO hr.employees FROM TSQL2012.hr.Employees;
GO
...
SELECT * INTO sales.Customers from TSQL2012.Sales.Customers
...
SELECT * INTO dbo.PotentialCustomers from TSQL2012.Sales.Customers
