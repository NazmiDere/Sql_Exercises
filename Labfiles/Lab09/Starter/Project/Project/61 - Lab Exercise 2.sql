...
SELECT o.orderid, SUM(od.qty * od.unitprice) As salesamount FROM Sales.Orders AS o INNER JOIN Sales.OrderDetails AS od ON o.orderid = od.orderid GROUP BY o.orderid, o.orderdate ORDER BY salesamount DESC;
...
SELECT o.orderid, SUM(od.qty * od.unitprice) AS salesamount, COUNT(*) AS noofoderlines, AVG(od.qty * od.unitprice) AS avgsalesamountperorderline
